...
function SubmitButton({ type }: { type: "plus" | "minus" }) {
  return (
    <button
      ...
      className={clsx(
        "ease flex h-full min-w-9 cursor-pointer max-w-9 flex-none items-center justify-center rounded-xl p-2 transition-all duration-200 hover:border-neutral-800 hover:opacity-80",
        {
          "ml-auto": type === "minus",
        }
      )}
