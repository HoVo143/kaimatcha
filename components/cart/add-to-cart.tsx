...
export function SubmitButton({
  ...
  const baseClasses =
    "relative text-nowrap flex w-full items-center justify-center rounded-xs cursor-pointer p-4.5 tracking-wide font-medium overflow-hidden transition-all duration-500";
  const normalClasses =
