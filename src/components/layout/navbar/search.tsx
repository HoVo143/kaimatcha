...
export default function Search() {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="w-max-[550px] relative w-80 lg:w-80 xl:w-70 bord border-b border-b-gray-500"
    >
      <input
        ref={inputRef}
        ...
        className="text-md w-full py-2 text-white placeholder:text-neutral-300 md:text-sm"
      />
